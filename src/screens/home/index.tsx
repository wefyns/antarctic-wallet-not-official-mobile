        ...
        <View style={styles.container}>
          ...
          <View style={styles.balanceCard}>
            ...
            <Text style={styles.balanceAmount}>
              {userData.settings.hideBalance 
                ? '••••••' 
                : `${totalBalance.toFixed(2)} ${balanceCurrency}`
              }
            </Text>
          ...
          <View style={styles.scannerCard}>
            <View style={styles.scannerContent}>
              ...
              <Text style={styles.scannerDescription}>
                Отсканируйте QR код СБП для оплаты
              </Text>
            </View>
            <CustomButton 
              title="Открыть QR сканнер" 
                ...
                <View key={coin.code} style={styles.coinCard}>
                  <View style={styles.coinHeader}>
                    ...
                    <View style={styles.coinBalance}>
                      <Text style={styles.coinBalanceAmount}>
                        {userData.settings.hideBalance 
                          ? '••••' 
                      ...
                      <View style={styles.networksList}>
                        {coin.networks.map(network => (
                          <View 
                            ...
                            style={[
                              styles.networkBadge,
                              !network.isAvailable && styles.networkBadgeDisabled
                            ]}
                          >
                            <Text style={[
                              styles.networkBadgeText,
                              !network.isAvailable && styles.networkBadgeTextDisabled
                            ]}>
                              {network.network}
                            </Text>
                          </View>
